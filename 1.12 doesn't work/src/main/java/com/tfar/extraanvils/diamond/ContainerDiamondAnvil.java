  ...
  public ContainerDiamondAnvil(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player) {
    ...
    this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
      ...
      public boolean canTakeStack(EntityPlayer playerIn) {
        return (playerIn.capabilities.isCreativeMode || playerIn.experienceLevel >= ContainerDiamondAnvil.this.maximumCost) && ContainerDiamondAnvil.this.maximumCost > 0 && this.getHasStack();
      }
      ...
      public ItemStack onTake(EntityPlayer playerIn, @Nonnull ItemStack stack) {
        ...
        //damage the anvil
        if (!playerIn.capabilities.isCreativeMode && !worldIn.isRemote && iblockstate.getBlock() instanceof BlockDiamondAnvil && playerIn.getRNG().nextFloat() < breakChance) {
