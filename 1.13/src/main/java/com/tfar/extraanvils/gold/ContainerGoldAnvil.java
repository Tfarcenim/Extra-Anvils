  ...
  public ContainerGoldAnvil(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player) {
    ...
    this.addSlot(new Slot(this.outputSlot, 2, 134, 47) {
      ...
      public boolean canTakeStack(EntityPlayer playerIn) {
        return (playerIn.abilities.isCreativeMode || playerIn.experienceLevel >= ContainerGoldAnvil.this.maximumCost) && ContainerGoldAnvil.this.maximumCost > 0 && this.getHasStack();
      }
      ...
      public ItemStack onTake(EntityPlayer playerIn, @Nonnull ItemStack stack) {
        ...
        if (!playerIn.abilities.isCreativeMode && !worldIn.isRemote && iblockstate.getBlock() instanceof BlockGoldAnvil && playerIn.getRNG().nextFloat() < breakChance) {
      ...
      public float getBreakChance(EntityPlayer playerIn, ItemStack stack){
        return ForgeHooks.onAnvilRepair(playerIn, stack, ContainerGoldAnvil.this.inputSlots.getStackInSlot(0), ContainerGoldAnvil.this.inputSlots.getStackInSlot(1))/4;
      }
    });
